...
declare const _default: (React.ComponentClass<Pick<Props, never> & {
...
}, any> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & {
    ...
    theme?: import("@callstack/react-theme-provider").$DeepPartial<import("../../../src/types").Theme> | undefined;
}> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & {
    (props: Props): JSX.Element;
    title: string;
}) | (React.FunctionComponent<Props> & {
    (props: Props): JSX.Element;
