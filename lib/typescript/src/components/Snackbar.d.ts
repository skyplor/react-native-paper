...
}, any> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & typeof Snackbar) | (React.FunctionComponent<Props> & typeof Snackbar), {}>) | (React.FunctionComponent<Pick<Props, "style" | "children" | "visible" | "duration" | "onDismiss" | "action"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<Theme> | undefined;
}> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & typeof Snackbar) | (React.FunctionComponent<Props> & typeof Snackbar), {}>);
