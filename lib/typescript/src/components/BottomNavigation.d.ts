...
declare class BottomNavigation extends React.Component<Props, State> {
    ...
    _handleKeyboardShow: () => void;
    _handleKeyboardHide: () => void;
    _animateToCurrentIndex: () => void;
    _handleLayout: (e: LayoutChangeEvent) => void;
    _handleTabPress: (index: number) => void;
    _jumpTo: (key: string) => void;
    _isShifting: () => boolean;
    render(): JSX.Element;
}
declare const _default: (React.ComponentClass<Pick<Props, "style" | "shifting" | "labeled" | "navigationState" | "onIndexChange" | "renderScene" | "renderIcon" | "renderLabel" | "getLabelText" | "getAccessibilityLabel" | "getTestID" | "getBadge" | "getColor" | "onTabPress" | "activeColor" | "inactiveColor" | "keyboardHidesNavigationBar" | "barStyle"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<Theme> | undefined;
}, any> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & typeof BottomNavigation) | (React.FunctionComponent<Props> & typeof BottomNavigation), {}>) | (React.FunctionComponent<Pick<Props, "style" | "shifting" | "labeled" | "navigationState" | "onIndexChange" | "renderScene" | "renderIcon" | "renderLabel" | "getLabelText" | "getAccessibilityLabel" | "getTestID" | "getBadge" | "getColor" | "onTabPress" | "activeColor" | "inactiveColor" | "keyboardHidesNavigationBar" | "barStyle"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<Theme> | undefined;
}> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<Props, any> & typeof BottomNavigation) | (React.FunctionComponent<Props> & typeof BottomNavigation), {}>);
